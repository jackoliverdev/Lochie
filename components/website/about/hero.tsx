...
export const AboutHero = () => {
  return (
    <section className="relative min-h-[100svh] lg:min-h-screen flex items-center justify-center overflow-hidden pt-28 sm:pt-24 lg:pt-0 pb-8 lg:pb-0">
      ...
      {/* Content */}
      <div className="relative z-20 max-w-5xl mx-auto px-4 lg:px-6 text-center text-white py-4 lg:py-0">
        ...
        >
          ...
          <p className="text-base sm:text-xl lg:text-2xl text-cyan-200 max-w-4xl mx-auto leading-relaxed px-4 lg:px-0">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm lg:text-base">Born in Gili Islands, Indonesia</span>
          </div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm lg:text-base">5.0 • 500+ Reviews</span>
          </div>
        </motion.div>
      </div>
