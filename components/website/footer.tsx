...
export const Footer: FC = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-t from-black/95 via-gray-900/95 to-black/95 text-white overflow-hidden backdrop-blur-md border-t border-gray-700/30">
      {/* Floating Background Elements - Hidden on mobile */}
      <div className="absolute top-6 left-10 opacity-10 hidden lg:block">
        <Waves className="w-16 h-16 text-cyan-400 animate-pulse" />
      </div>
      <div className="absolute bottom-6 right-20 opacity-10 hidden lg:block">
        <Anchor className="w-12 h-12 text-blue-400 animate-float" />
      </div>
      
      {/* Main Footer Content */}
      <div className="relative z-10 container mx-auto px-4 lg:px-6 py-3 lg:py-12">
        ...
        <div className="lg:hidden">
          <div className="flex items-center justify-between py-2">
            ...
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-sm font-bold text-white">
                Jasper <span className="text-cyan-400">Luxury</span>
              </span>
            </Link>
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                href="/booking"
                className="bg-cyan-500 text-white px-3 py-1.5 rounded-lg text-xs font-semibold flex items-center justify-center"
              >
                Book
              </Link>
            </div>
          ...
          <div className="py-2 border-t border-white/10">
            <div className="flex items-center justify-center gap-4 text-xs">
              <Link href="/" className="text-gray-300 hover:text-cyan-300 transition-colors">Home</Link>
              <Link href="/booking" className="text-gray-300 hover:text-cyan-300 transition-colors">Booking</Link>
              <Link href="/experiences" className="text-gray-300 hover:text-cyan-300 transition-colors">Experiences</Link>
              <Link href="/gallery" className="text-gray-300 hover:text-cyan-300 transition-colors">Gallery</Link>
              <Link href="/about" className="text-gray-300 hover:text-cyan-300 transition-colors">About</Link>
            </div>
          </div>
          ...
          <div className="py-2 border-t border-white/10">
            <div className="flex items-center justify-center gap-6 text-xs">
              <Link href="#" className="text-gray-400 hover:text-cyan-300 transition-colors">Privacy Policy</Link>
              <Link href="#" className="text-gray-400 hover:text-cyan-300 transition-colors">Terms of Service</Link>
            </div>
          </div>
        ...
        <div className="hidden lg:grid lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <Link
              href="/booking"
              className="inline-block bg-cyan-500 hover:bg-cyan-600 text-white px-6 py-3 rounded-full font-semibold text-sm transition-all duration-300 hover:scale-105"
            >
              Book Your Adventure
            </Link>
          </div>
        ...
        {/* Desktop Bottom Bar */}
        <div className="hidden lg:block border-t border-white/10 mt-8 pt-6">
